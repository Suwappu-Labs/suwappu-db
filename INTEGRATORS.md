...
```toml
[dependencies]
suwappudb-bridge = { git = "https://github.com/suwappu/suwappu-db", tag = "v0.1.0-pre" }
suwappudb-state  = { git = "https://github.com/suwappu/suwappu-db", tag = "v0.1.0-pre" }
```
...
- **Issue tracker:** https://github.com/suwappu/suwappu-db/issues
