...
Python misc                                        228
Rust gsxdb-state lib                               101  ★ NEW
Rust gsxdb-bridge lib                              112  ★ NEW
Rust gsxdb-state integration (state_tree)            6  ★ NEW
Rust gsxdb-bridge integration                       38  ★ NEW
Rust gsxdb-lane lib                                  2  ★ NEW
  proptest cases / invariant                  10,000   ★ NEW
 Total                                          1,603  (was 1,344)
```

The Rust integration tests are partitioned across seven
integration targets in `crates/gsxdb-bridge/tests/`:
...
each of the eight load-bearing invariants enumerated in [GSX DAG L1,
