...
Suwappu-DB is the storage and validation engine underneath the Suwappu Labs. Phase 1 lands the dual-VM database (EVM + Move) on a custom Verkle-rooted state lane with cross-parity against `LTPAnchorRegistry`.
