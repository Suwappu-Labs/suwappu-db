...
use suwappudb_state::{EvmTx, MoveTx, State};
...
mod tests {
    use super::*;
    use suwappudb_state::{Address, Balance, BridgeToken, EvmView, MoveView, StateChange};
    use suwappudb_state::{EvmProjector, MoveProjector};
