...
//!
//! We use [`suwappudb_state::State::apply`] directly with a fresh token,
...
use suwappudb_state::{Address, Balance, BalanceSlot, BridgeToken, State, StateChange, StateTree};
use rayon::prelude::*;
...
pub struct BlockReport {
    ...
    pub state_root: suwappudb_state::Commitment,
    ...
    /// liveness bugs.
    pub collapsed_to_sequential: Option<suwappudb_state::Address>,
}
...
impl BlockExecutor {
    ...
    pub fn execute_with_registry(
        ...
        let mut collapsed_hot_addr: Option<suwappudb_state::Address> = None;
