...
//!
//! **Gated.** The test is skipped silently unless `SUWAPPUDB_SHADOW_RPC`
//! is set in the environment. Local dev + CI without an op-reth
//! reachable see a no-op; ops can opt in by exporting:
//!
//! ```sh
//!   export SUWAPPUDB_SHADOW_RPC=http://18.226.17.168:8545
...
use suwappudb_bridge::sync::l2::{L2StateSyncer, L2SyncConfig};
use suwappudb_state::Address;
use std::env;

const ENV_SHADOW_RPC: &str = "SUWAPPUDB_SHADOW_RPC";
