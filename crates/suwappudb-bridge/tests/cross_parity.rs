...
use suwappudb_bridge::{Anchor, AnchorDispatcher, AnchorHash, ChainId, ParityResult, GENESIS_PARENT};
...
proptest! {
    ...
    fn parity_detects_tampering(
        ...
        let forged = Anchor {
            ...
            mac: [0; 32],
            auth_scheme: suwappudb_bridge::anchor::types::AuthScheme::Blake3Mac,
        };
