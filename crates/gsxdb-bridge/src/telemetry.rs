...
//!
//! Records metrics to a shared [`gsxdb_state::Metrics`] instance for
//! Prometheus export and observability dashboards.

use gsxdb_state::Metrics;
use std::sync::Arc;
...
pub fn record_state_metrics(metrics: &Metrics, state: &gsxdb_state::State) {
...
mod tests {
    ...
    fn record_state_metrics_updates_counters() {
        ...
        let state = gsxdb_state::State::default();
